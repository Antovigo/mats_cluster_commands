...
#SBATCH --job-name=import_numpy   # Name for your job
#SBATCH --output=import_numpy_%j.log # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/pile_llama_import_numpy/pile_llama_targeted.yaml \
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/pile_llama_import_numpy/experimental_plan.yaml
