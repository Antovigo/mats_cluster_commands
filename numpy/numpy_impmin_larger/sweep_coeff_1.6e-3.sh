...
#SBATCH --job-name=impmin_larger_1.6    # Name for your job
#SBATCH --output=impmin_larger_1.6_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_larger/experimental_plan_coeff_1.6e-3.yaml
