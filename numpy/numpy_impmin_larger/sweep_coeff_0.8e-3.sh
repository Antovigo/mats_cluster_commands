...
#SBATCH --job-name=impmin_larger_0.8    # Name for your job
#SBATCH --output=impmin_larger_0.8_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_larger/pile_llama_targeted.yaml \
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_larger/experimental_plan_coeff_0.8e-3.yaml
