...
#SBATCH --job-name=impmin_8x       # Name for your job
#SBATCH --output=impmin_8x_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_scheduling/pile_llama_targeted.yaml \
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_scheduling/experimental_plan_peak_8x.yaml
