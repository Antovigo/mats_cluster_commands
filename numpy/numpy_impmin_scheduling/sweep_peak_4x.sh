...
#SBATCH --job-name=impmin_4x       # Name for your job
#SBATCH --output=impmin_4x_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_scheduling/experimental_plan_peak_4x.yaml
