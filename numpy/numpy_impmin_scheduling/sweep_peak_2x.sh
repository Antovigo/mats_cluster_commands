...
#SBATCH --job-name=impmin_2x       # Name for your job
#SBATCH --output=impmin_2x_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_scheduling/experimental_plan_peak_2x.yaml
