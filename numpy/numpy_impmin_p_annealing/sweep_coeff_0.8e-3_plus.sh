...
#SBATCH --job-name=p_anneal_0.8+   # Name for your job
#SBATCH --output=p_anneal_0.8+_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_p_annealing/experimental_plan_coeff_0.8e-3_plus.yaml
