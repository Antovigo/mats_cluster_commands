...
#SBATCH --job-name=p_anneal_1.2+   # Name for your job
#SBATCH --output=p_anneal_1.2+_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_p_annealing/experimental_plan_coeff_1.2e-3_plus.yaml
