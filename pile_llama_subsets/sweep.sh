...
#SBATCH --job-name=pile_subsets   # Name for your job
#SBATCH --output=pile_subsets_%j.log # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/pile_llama_subsets/pile_llama_targeted.yaml \
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/pile_llama_subsets/experimental_plan.yaml
