...
#SBATCH --job-name=late_PGD   # Name for your job
#SBATCH --output=late_PGD_%j.log # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/pile_llama_late_PGD/pile_llama_constant_coeff1.yaml \
