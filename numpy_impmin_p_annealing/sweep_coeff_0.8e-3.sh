...
#SBATCH --output=p_anneal_0.8_%j.log  # Log file for stdout/stderr (%j = Job ID)
...
uv run spd/scripts/run_variations.py \
  ...
  /mnt/nw/home/a.vigouroux/SPD/batch_commands/numpy_impmin_p_annealing/experimental_plan_coeff_0.8e-3.yaml
